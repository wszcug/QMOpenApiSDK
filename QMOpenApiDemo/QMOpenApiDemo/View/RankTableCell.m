...
- (void) updateCellWithRank:(QPRank *)rank{
    self.songLabel.text = rank.name;
    self.singerLabel.text = [NSString stringWithFormat:@"歌曲数量：%ld",(long)rank.total];
    [self.albumCoverImageView sd_setImageWithURL:rank.headerURL placeholderImage:[UIImage imageNamed:@"default_album"]];
}
